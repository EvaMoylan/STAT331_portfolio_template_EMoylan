...
#Note: Original code was modified to filter using max and min arguments in one pipeline instead of slice_min and slice_max in seperate pipelines.
```
...
teacher_evals_clean |>
  filter(seniority == 1) |> #Keep only instructors with 1 year of experience, seniority = factor
  group_by(teacher_id) |>
...
#Note: Original code was modified to use summarize to count the number of questions per teacher and course combination.
```
...
#Note: Original code was changed to call on SET_level and sen_level in the teacher_evals_compare dataset within the chisq.test function instead of creating a table seperately and calling on the table.
```
...
I feel confident in my effort to extend my thinking so far in this course. I made an effort to challenge myself on challenge assignments when possible. For example, for Challenge 3, I completed the 'hot' assignment to push what I was comfortable with when using ggplot2. The annotate( ) function was new to me and I chose this assignment to learn new ggplot2 skills. For labs and challenge assignments where we were required to re-create plots, I also tried to match the appearance of the plot (i.e. style, colors) as close as possible to the example instead of only matching the visualization of the data. Where I think I have room for improvement is thinking more broadly about new functions I can use to complete a task more efficiently, even if I can do it correctly using a different method. For example, using filtering joins instead of the filter( ) argument when applicable. So, this is where I feel I haven't earned a full A at this point in the quarter.

## Peer Support & Collaboration

<!-- Include an image or a description of feedback you gave that you are proud of (either in a peer review or in Discord). -->

![](images/Screenshot 2024-11-03 at 9.36.52 PM.png){width="470"}
