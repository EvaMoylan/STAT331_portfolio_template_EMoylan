...
AgesXLSX <- read_xlsx(here::here("Week 2", 
                                 ...
                                 "ages.xlsx"), 
                      sheet = "ages") 
#Load ages excel file, looks like first sheet is blank so this specifies to load the sheet named "ages" stored within the same file
```
...
AgesMystery <- read_delim(here::here("Week 2", 
                                     ...
                                     "ages_mystery.txt"), 
                          delim = "|") 
#This is not already spaced so add delim = "|" to separate lists
```
